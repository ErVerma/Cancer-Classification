...
public class NearestNeighborTester
{
  ...
  { 
    ...
    int myChoice=0;//to test for choiced k values
  boolean again=true;
  while(again) {
  try{
      readFile(args[0]);
      ...
      System.out.println("Average accuracy is " + (totalaccuracy/numberofrepetitions) + "% over " +numberofrepetitions + " repetitions"); // print accuracy
      System.out.println("Enter 1 for more K values 0 for exit");
      myChoice=sc.nextInt();
      ...
      while(myChoice!=0)
      {
        ...
        System.out.println("Average accuracy is " + (totalaccuracy/numberofrepetitions) + "% over " +numberofrepetitions + " repetitions"); //print accuracy and k value
        //
        System.out.println("Enter 1 for more K values 0 for exit");
        myChoice=sc.nextInt();
      }
